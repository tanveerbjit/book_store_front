...
const onSubmit = async (data) => {
  try {
    ...
    if (response.status === 200) {
      ...
      setPic("http://127.0.0.1:3000/"+responseData.data.pic)
      setIsLoading(false);
    } else {
          ...
          <div className="col-lg-9 col-12 mt-3 mt-lg-0">
            ...
            <div className="row mt-lg-3 mt-1">
              ...
              <div className="col-lg-4 col-12">
                <label className="docboard-title text-gray-dark text-capitalize d-block mb-2">First Name </label>
                <Controller
                  name="first_name"
                  control={control}
                  rules={{
              ...
              <div className="col-lg-4 col-12 my-2 my-lg-0">
                <label className="docboard-title text-gray-dark text-capitalize d-block mb-2">Last Name </label>
                <Controller
                  name="last_name"
                  control={control}
                  rules={{
              ...
              {/* Phone */}
              <div className="col-lg-4 col-12">
                <label className="docboard-title text-gray-dark text-capitalize d-block mb-2">Phone</label>
                <Controller
                  name="phone"
                  control={control}
                  rules={{
                    ...
                    pattern: {
                      ...
                      message: 'Invalid phone only bangladeshi number is acceptable',
                    },
                  }}
                  render={({ field }) => (
                    <input
            ...
            <div className="row mt-2 mt-lg-3">
              <div className="col-lg-4">
                <label htmlFor="email" className="docboard-title text-gray-dark text-capitalize d-block mb-2">
                  Email Address <span className="text-danger fw-bold">(not editable)</span>
                </label>
                <Controller
                  name="email"
                  control={control}
              ...
              <div className="col-lg-4">
                <label className="docboard-title text-gray-dark text-capitalize d-block mb-2">
                  User Name <span className="text-danger fw-bold">(not editable)</span>
                </label>
                <Controller
                  name="user_name"
                  control={control}
            ...
            <div className="row mt-2 mt-lg-3">
              <div className="col-lg-12">
                <label className="docboard-title text-gray-dark text-capitalize d-block mb-2">Address </label>
                <Controller
                  name="address"
                  control={control}
                  render={({ field }) => (
